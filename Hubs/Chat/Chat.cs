...
using CollegeHumorContentProvider = Devq.Employees.Hubs.Chat.ContentProviders.CollegeHumorContentProvider;
using Cookie = Microsoft.AspNet.SignalR.Cookie;
using IContentProvider = Devq.Employees.Hubs.Chat.ContentProviders.IContentProvider;
using ImageContentProvider = Devq.Employees.Hubs.Chat.ContentProviders.ImageContentProvider;
using YouTubeContentProvider = Devq.Employees.Hubs.Chat.ContentProviders.YouTubeContentProvider;

namespace Devq.Employees.Hubs.Chat
{
    ...
    public class Chat : Hub
    {
            ...
            IContentManager contentManager) 
        {
            ...
            // General
            _rooms.TryAdd("All", new ChatRoom());

            // Department rooms
            foreach (var dep in departments.List()) {
                _rooms.TryAdd(dep.As<TitlePart>().Title, new ChatRoom());
            }
        }
